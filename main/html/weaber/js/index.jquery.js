// 전역변수선언
var cityId;
var key = '046c5a1590431a2ebb1eee538f7d8a40';
var units = 'metric';
...
function dailyFn(res) {
	...
	*/
	...
	$d.append('<div class="text-center py-3"><img class="daily-img" src="../img/icon/' + res.weather[0].icon + '.png" class="w-100"></div>');
...
function weeklyFn(res) {
	...
	for (var v of res.list) {
		...
		<li class="w-item">
					<div>
						<img src="../img/icon/${v.weather[0].icon}.png" class="w-100" alt="">
					</div>
					<ul>
						<li class="w-temp">
