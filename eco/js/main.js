...
/*
$(객체).animate({애니메이션 될 css}, [1000(속도)], [timing func], [function(){애니메이션 종료 후 발생할 함수}]);
*/
...
var ads = [
	{
		...
		src: "../img/ecofood_01_x1024 - 복사본.png",
		title: "Diabetic Nutrition",
		desc: "Maximum comfortable gradual weight loss <br> and the establishment of metabolic processes <br> in the body.",
		link: "https://daum.net",
		position: "center"
...
//배너이미지의 높이를 가져다가 .ads의 높이 생성
// resize - 객체의 크기가 변경될 시
...
var populars = [
	{
		src: "../img/Adoloremque_600x.jpg",
		title: "Adoloremque",
		price: "$48.00"
	},
	{
		src: "../img/Aperiam_600x.jpg",
		title: "Aperiam",
		price: "$48.00"
	},
	{
		src: "../img/Architecto_600x.jpg",
		title: "Architecto",
		price: "$48.00"
	},
	{
		src: "../img/Beatae_vitae_600x.jpg",
		title: "Beatae vitae",
		price: "$48.00"
	},
	{
		src: "../img/Consequuntur_600x.jpg",
		title: "Consequuntur",
		price: "$48.00"
	},
	{
		src: "../img/Dicta_600x.jpg",
		title: "Dicta",
		price: "$48.00"
	},
	{
		src: "../img/Magni_dolores_600x.jpg",
		title: "Dolores",
		price: "$48.00"
	},
	{
		src: "../img/Eaque_ipsa_quae_ab_illo_600x.jpg",
...
html ='<ul class="prd my-4 pointer position-relative">';
html +='<li class="prd-img"><img src="'+populars[i].src+'" alt="" class="w-100"></li>';
...
html +='</li>';
html +='<li data-toggle="tooltip" data-placement="left" title="Quick view" class="tooltip-bt prd-icon prd-view"><i class="fas fa-eye"></i></li>';
html +='<li data-toggle="tooltip" data-placement="left" title="You need to login" class="tooltip-bt prd-icon prd-login"><i class="fas fa-heart"></i></li>';
html +='<li data-toggle="tooltip" data-placement="left" title="Add to Compare" class="tooltip-bt prd-icon prd-compare"><i class="fas fa-balance-scale"></i></li>';
html +='</ul>';
